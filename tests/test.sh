...
function test_basic() {
  ...
  try_direct 'leading attribute decl' 0 'extern __attribute__((unused)) int foo; int main(void){return 0;}'
  try_direct 'leading _Noreturn decl' 0 'extern _Noreturn void foo(void); int main(void){return 0;}'
