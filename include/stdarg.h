...
#ifdef __aarch64__
//# define __va_arg_struct(ap, ty)  ((char*)__va_arg_gp(ap, sizeof(ty *), _Alignof(ty *)))
# define __va_arg_struct(ap, ty)  (sizeof(ty) <= 16 ? __va_arg_gp(ap, sizeof(ty *), _Alignof(ty *)) : ((char*)*(ty **)__va_arg_gp(ap, sizeof(ty *), _Alignof(ty *))))
#else
