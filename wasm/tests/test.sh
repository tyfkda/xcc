...
try_direct 'while' 55 'int main(){int acc=0, i=1; while (i<=10) {acc+=i; i+=1;} return acc;}'
try_direct 'do-while' 55 'int main(){int acc=0, i=1; do {acc+=i; i+=1;} while (i<=10); return acc;}'
