...
enum RawOpcode {
  ...
  R_SLL, R_SLLW, R_SLLI, R_SLLIW,
  R_SRL, R_SRLW, R_SRLI, R_SRLIW,
  R_SRA, R_SRAW, R_SRAI, R_SRAIW,
  R_LB, R_LH, R_LW, R_LD,
  R_LBU, R_LHU, R_LWU,
  R_SB, R_SH, R_SW, R_SD,
...
const ParseInstTable kParseInstTable[] = {
  ...
  [R_SLLW] = { 1, (const ParseOpArray*[]){ &(ParseOpArray){SLLW, {R64, R64, R64}} } },
  ...
  [R_SRLW] = { 1, (const ParseOpArray*[]){ &(ParseOpArray){SRLW, {R64, R64, R64}} } },
  ...
  [R_SRAW] = { 1, (const ParseOpArray*[]){ &(ParseOpArray){SRAW, {R64, R64, R64}} } },
  [R_SRAI] = { 1, (const ParseOpArray*[]){ &(ParseOpArray){SRAI, {R64, R64, IMM}} } },
  [R_SRAIW] = { 1, (const ParseOpArray*[]){ &(ParseOpArray){SRAIW, {R64, R64, IMM}} } },
  ...
  [R_FMV_D_X] = { 1, (const ParseOpArray*[]){ &(ParseOpArray){FMV_D_X, {F64, R64}} } },
  [R_FMV_W_X] = { 1, (const ParseOpArray*[]){ &(ParseOpArray){FMV_W_X, {F64, R64}} } },
