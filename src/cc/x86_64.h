...
#define MOVSX_AL_EAX()   do { ADD_ASM("movsx %%al, %%eax"); ADD_CODE(0x0f, 0xbe, 0xc0); } while (0)
#define MOVSX_AL_RAX()   do { ADD_ASM("movsx %%al, %%rax"); ADD_CODE(0x48, 0x0f, 0xbe, 0xc0); } while (0)
...
#define MOV_IND_RAX_DIL()  do { ADD_ASM("mov (%%rax), %%dil"); ADD_CODE(0x40, 0x8a, 0x38); } while (0)
#define MOV_IND_RAX_AX()   do { ADD_ASM("mov (%%rax), %%ax"); ADD_CODE(0x66, 0x8b, 0x00); } while (0)
#define MOV_IND_RAX_DI()   do { ADD_ASM("mov (%%rax), %%di"); ADD_CODE(0x66, 0x8b, 0x38); } while (0)
#define MOV_IND_RAX_EAX()  do { ADD_ASM("mov (%%rax), %%eax"); ADD_CODE(0x8b, 0x00); } while (0)
#define MOV_IND_RAX_EDI()  do { ADD_ASM("mov (%%rax), %%edi"); ADD_CODE(0x8b, 0x38); } while (0)
...
#define MOV_DIL_AL()           do { ADD_ASM("mov %%dil, %%al"); ADD_CODE(0x40, 0x88, 0xf8); } while (0)
...
#define MOV_DI_AX()            do { ADD_ASM("mov %%di, %%ax"); ADD_CODE(0x66, 0x89, 0xf8); } while (0)
#define MOV_EDI_EAX()          do { ADD_ASM("mov %%edi, %%eax"); ADD_CODE(0x89, 0xf8); } while (0)
