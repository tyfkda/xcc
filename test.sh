...
try 'positive var' 42 'int x; x = 42; return +x;'
try 'negative var' 214 'int x; x = 42; return -x;'
...
try '+=' 13 'int x; x = 10; x += 3; return x;'
try '-=' 7 'int x; x = 10; x -= 3; return x;'
try '*=' 30 'int x; x = 10; x *= 3; return x;'
try '/=' 3 'int x; x = 10; x /= 3; return x;'
try '%=' 1 'int x; x = 10; x %= 3; return x;'
...
try 'while' 55 'int i; int acc; i = acc = 0; while (i <= 10) { acc += i; ++i; } return acc;'
...
try 'while-break' 10 'int i; int acc; i = acc = 0; while (++i <= 10) { if (i == 5) break; acc += i; } return acc;'
try 'while-continue' 50 'int i; int acc; i = acc = 0; while (++i <= 10) { if (i == 5) continue; acc += i; } return acc;'
try 'do-while-break' 10 'int i; int acc; i = acc = 0; do { if (i == 5) break; acc += i; } while (++i <= 10); return acc;'
try 'do-while-continue' 50 'int i; int acc; i = acc = 0; do { if (i == 5) continue; acc += i; } while (++i <= 10); return acc;'
