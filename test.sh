...
try 4 'int x; int y; x = 1; y = ++x; return x + y;'
try 0 'int x; int y; x = 1; y = --x; return x + y;'
try 3 'int x; int y; x = 1; y = x++; return x + y;'
try 1 'int x; int y; x = 1; y = x--; return x + y;'
try_direct 23 'int foo(){ return 123; } void main(){ _exit(foo() - 100); }'
try_direct 9 'int sqsub(int x, int y){ int xx; int yy; xx = x * x; yy = y * y; return xx - yy; } void main(){ _exit(sqsub(5, 4)); }'
try 2 'if (1) return 2;'
