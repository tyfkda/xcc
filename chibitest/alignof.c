...
//  { char x[16]; ASSERT(0, ((unsigned long)&x % 16)); }
//  { char x[17]; ASSERT(0, ((unsigned long)&x % 16)); }
//  { char x[100]; ASSERT(0, ((unsigned long)&x % 16)); }
//  { char x[101]; ASSERT(0, ((unsigned long)&x % 16)); }
